...
object ExpressionMappings {
  ...
  private val AGGREGATE_SIGS: Seq[Sig] = Seq(
    ...
    Sig[RegrCount](REGR_COUNT),
    Sig[RegrR2](REGR_R2),
    Sig[RegrSlope](REGR_SLOPE),
    Sig[RegrIntercept](REGR_INTERCEPT),
    Sig[RegrSXY](REGR_SXY),
    Sig[RegrSXX](REGR_SXX),
    Sig[RegrSYY](REGR_SYY),
    Sig[RegrReplacement](REGR_REPLACEMENT),
    Sig[Corr](CORR),
