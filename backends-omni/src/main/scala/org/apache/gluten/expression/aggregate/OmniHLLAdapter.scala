...
// HLL in Omni's intermediate type is varbinary, which is different from Spark HLL.
// We add this wrapper to align the intermediate type for HLL functions.
case class OmniHLLAdapter(
    child: Expression,
  ...
  override def prettyName: String = "omni_approx_count_distinct"
  ...
  override protected def withNewChildrenInternal(
      newLeft: Expression,
      newRight: Expression): OmniHLLAdapter =
