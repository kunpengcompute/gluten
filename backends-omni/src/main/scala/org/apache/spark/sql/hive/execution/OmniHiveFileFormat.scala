...
import org.apache.spark.sql.hive.{HiveInspectors, HiveShim, HiveTableUtil}
 ...
 */
class OmniHiveFileFormat(fileSinkConf: HiveShim.ShimFileSinkDesc)
...
class HiveOutputWriter(
                        val path: String,
                        fileSinkConf: HiveShim.ShimFileSinkDesc,
                        jobConf: JobConf,
