...
import org.apache.spark.sql.hive.{HiveExternalCatalog, HiveShim}
...
object OmniInsertIntoHiveTable extends V1WritesHiveUtils {
  def apply(
    ...
    val fileSinkConf = new HiveShim.ShimFileSinkDesc(hiveTempPath.externalTempPath.toString, tableDesc, false)
