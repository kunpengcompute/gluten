 ...
 *
 * This file is copied from Delta 2.3.0 and customized for omni delta integration:
 *   1. return OmniOptimisticTransaction
 *   2. keep insertable relations pointing back to WriteIntoDelta
 */
/**
...
class DeltaLog private(
  ...
  def startTransaction(snapshotOpt: Option[Snapshot]): OptimisticTransaction = {
    // --- modified start
    new OmniOptimisticTransaction(this, snapshotOpt)
    // --- modified end
  }
